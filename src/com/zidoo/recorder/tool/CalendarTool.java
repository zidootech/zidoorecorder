 ...
 * @author
 */
public class CalendarTool implements OnDateChangedListener,
	 ...
	 */
	public CalendarTool(Activity activity, String initDateTime) {
	...
	public AlertDialog dateTimePicKDialog() {
		...
		View dateTimeLayout = inflater.inflate(R.layout.select_data, null);

		// LinearLayout dateTimeLayout = (LinearLayout) ((Activity) context)
		// .getLayoutInflater().inflate(R.layout.select_data, null);
